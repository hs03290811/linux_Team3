...
extern struct nf_conntrack_bucket *nf_conntrack_hash;
...
nf_conntrack_get_ht(struct nf_conntrack_bucket **hash, unsigned int *hsize)
{
	// struct hlist_nulls_head *hptr;
    struct nf_conntrack_bucket *hptr;
